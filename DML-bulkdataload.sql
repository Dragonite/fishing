...
insert into users(username, firstName, lastName, email, createdAt, isActive, isAdmin)
...
insert into users(username,firstName, lastName, email, ad_street, ad_suburb, ad_state, createdAt, isActive)
